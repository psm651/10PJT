		...
		function checkId() {
	        ...
	        $.ajax({
	            ...
	            success : function(JSONData , status) {
	                if(!JSONData||inputed==""||inputed.length<5) {
	                $("input[name='userId']").css("background-color", "#FFCECE");
	                } else if (JSONData||inputed.length>5) {
	                $("input[name='userId']").css("background-color", "#B0F6AC");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						<input 	type="text" name="userId" class="ct_input_g" oninput="checkId()"
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="password" name="password" class="ct_input_g" oninput="checkPassword()"
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input 	type="password" name="password2" class="ct_input_g" oninput="checkPassword2()"
							style="width:100px; height:19px"  maxLength="10" minLength="6"  />
		</td>
	</tr>
